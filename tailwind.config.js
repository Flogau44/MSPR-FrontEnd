...
module.exports = {
  ...
  theme: {
    colors: {
      white: "#ffffff",
      brown: "#2c1e1e",
      "brown-700": "rgba(44, 30, 30, 0.7)",
      "brown-900": "rgba(44, 30, 30, 0.9)",
      black: "#1f1615",
      blue: "#55c0cf",
      orange: "#b65f28",
      "orange-900": "rgba(182, 95, 40, 0.9)",
      "orange-700": "rgba(182, 95, 40, 0.7)",
      yellow: "#ffd543",
      "yellow-900": "rgba(255, 213, 67, 0.9)",
      "yellow-700": "rgba(255, 213, 67, 0.7)",
      grey: "#eceff3",
    },
    extend: {
      fontFamily: {
